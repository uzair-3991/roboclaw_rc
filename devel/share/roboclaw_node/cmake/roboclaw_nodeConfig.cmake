...
if("TRUE" STREQUAL "TRUE")
  set(roboclaw_node_SOURCE_PREFIX /home/bfb-sc/catkin_ws/src/roboclaw_ros/roboclaw_node)
  set(roboclaw_node_DEVEL_PREFIX /home/bfb-sc/catkin_ws/devel)
  ...
  set(roboclaw_node_INSTALL_PREFIX /home/bfb-sc/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'roboclaw_node' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Brad Bazemore <bwbazemore@uga.edu>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'roboclaw_node' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bfb-sc/catkin_ws/src/roboclaw_ros/roboclaw_node/${idir}'.  Ask the maintainer 'Brad Bazemore <bwbazemore@uga.edu>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${roboclaw_node_dep}_FOUND)
      find_package(${roboclaw_node_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${roboclaw_node_dep} REQUIRED ${depend_list})
  endif()
