...
(cl:in-package roboclaw_ros-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <roboclaw_service-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'roboclaw_service-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboclaw_ros-srv:<roboclaw_service-request> is deprecated: use roboclaw_ros-srv:roboclaw_service-request instead.")))

(cl:ensure-generic-function 'enc-val :lambda-list '(m))
(cl:defmethod enc-val ((m <roboclaw_service-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboclaw_ros-srv:enc-val is deprecated.  Use roboclaw_ros-srv:enc instead.")
  (enc m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<roboclaw_service-request>)))
  ...
  "roboclaw_ros/roboclaw_serviceRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'roboclaw_service-request)))
  "Returns string type for a service object of type 'roboclaw_service-request"
  "roboclaw_ros/roboclaw_serviceRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <roboclaw_service-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'roboclaw_service-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboclaw_ros-srv:<roboclaw_service-response> is deprecated: use roboclaw_ros-srv:roboclaw_service-response instead.")))

(cl:ensure-generic-function 'return_enc-val :lambda-list '(m))
(cl:defmethod return_enc-val ((m <roboclaw_service-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboclaw_ros-srv:return_enc-val is deprecated.  Use roboclaw_ros-srv:return_enc instead.")
  (return_enc m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<roboclaw_service-response>)))
  ...
  "roboclaw_ros/roboclaw_serviceResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'roboclaw_service-response)))
  "Returns string type for a service object of type 'roboclaw_service-response"
  "roboclaw_ros/roboclaw_serviceResponse")
